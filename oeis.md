...
| :--------------------------------: | :---------------------------------------------------------------: | :-------------------: | :--------------------------------: |
|           Nothing to do            |          List of sequences allocated for a specific user          | No particular request | [allocated](oeis_mds/allocated.md) |
| Check if this list if always empty | Done is a deprecated keyword, than this list must be always empty | No particular request |  [done](oeis_mds/done_keyword.md)  |
| Check if this list if always empty | Dupe is a deprecated keyword, than this list must be always empty | No particular request |  [dupe](oeis_mds/dupe_keyword.md)  |
| Check if this list if always empty | Huge is a deprecated keyword, than this list must be always empty | No particular request |  [huge](oeis_mds/huge_keyword.md)  |
| Add more terms | Huge is a deprecated keyword, than this list must be always empty | No particular request |  [more terms](oeis_mds/more_terms_needed.md)  |