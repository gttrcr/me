...
|  Id   |                                       Problem                                        |   Status   |                Topic                | Final result |
| :---: | :----------------------------------------------------------------------------------: | :--------: | :---------------------------------: | :----------: |
|   1   |                          Fisher Information (FI) properties                          | Completed  |        Calculus, Statistics         |              |
|   2   |                      Fisher Information matrix (FIM) properties                      | Completed  |    Calculus, Statistics, Algebra    |              |
